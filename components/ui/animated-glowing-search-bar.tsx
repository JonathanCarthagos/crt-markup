...
const AnimatedGlowingSearchBar: React.FC<AnimatedGlowingSearchBarProps> = ({
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <form onSubmit={handleSubmit} id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          <input 
            ...
            disabled={isLoading}
            className="bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white px-[59px] pr-[70px] text-lg focus:outline-none placeholder-gray-400 disabled:opacity-50" 
          />
